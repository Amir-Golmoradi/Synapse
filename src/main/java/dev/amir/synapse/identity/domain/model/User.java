...
public class User extends AggregateRoot<UserId, DomainEvent> {
  ...
  public static User reconstitute(
      ...
      FullName fullName,
      @Nullable String profilePictureUrl) {
    return new User(userId, email, googleId, fullName, profilePictureUrl);
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(getGoogleId(), user.getGoogleId())
        && Objects.equals(getEmail(), user.getEmail());
  }

  @Override
  public int hashCode() {
    return Objects.hash(getGoogleId(), getEmail());
  }
}
